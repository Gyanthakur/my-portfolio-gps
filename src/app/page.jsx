      ...
      <div className="h-screen flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 bg-gradient-to-t from-blue-50 to-blue-100">
        ...
        <div className="h-1/2 lg:h-full lg:w-1/2 flex flex-col gap-8 items-center justify-center ">
          ...
          <p className="md:text-xl">
            ...
            applications using React, Node.js, and MongoDB. I am always looking to learn new technologies and improve my skills. I am currently looking for new opportunities to work on exciting projects. 
          </p>
          {/* BUTTONS */}
